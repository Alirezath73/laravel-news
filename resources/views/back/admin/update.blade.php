                ...
                <div class="card-content">
                    <form class="form-horizontal" method="post" action="{{route('admin.update',$admin->id)}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input disabled type="text" name="first_name" class="form-control" id="inputEmail3"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input disabled type="text" name="last_name" class="form-control" id="inputEmail3"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input disabled type="text" name="mobile" class="form-control" id="inputEmail3"
                                       value="{{$admin->mobile}}">
                                @error('mobile')
                                <strong>{{$message}}</strong>
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input disabled type="email" name="email" class="form-control" id="inputEmail3"
                                       value="{{$admin->email}}">
                                @error('email')
                                <strong>{{$message}}</strong>
                                @enderror
